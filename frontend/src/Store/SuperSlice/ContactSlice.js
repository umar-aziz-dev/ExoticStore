...
export const AddContact = createAsyncThunk(
    ...
    async (formData, { rejectWithValue }) => {
        try {
            const res = await axios.post("/api/superadmin/contactus/add", formData);
            return res.data;
        } catch (err) {
...
export const fetchContact = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            const res = await axios.get("/api/superadmin/contactus/get");
            return res.data;
        } catch (err) {
...
export const deleteContact = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            const res = await axios.delete("/api/superadmin/contactus/delete");
            return res.data;
        } catch (err) {
