  ...
  async (formData, { rejectWithValue }) => {
    try {
      const result = await axios.post(
        "http://localhost:4000/api/superadmin/policycreation/add",
        formData
      );
      return result.data;
    } catch (error) {
  ...
  async (_, { rejectWithValue }) => {
    try {
      const result = await axios.get(
        "http://localhost:4000/api/superadmin/policycreation/get"
      );
      return result.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || "Something went wrong");
  ...
  async (id, { rejectWithValue }) => {
    try {
      const result = await axios.delete(
        `http://localhost:4000/api/superadmin/policycreation/delete/${id}`
      );
      return result.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || "Something went wrong");
  ...
  async ({ formData, id }, { rejectWithValue }) => {
    try {
      const result = await axios.put(
        `http://localhost:4000/api/superadmin/policycreation/edit/${id}`,
        formData
      );
      return result.data;
    } catch (error) {
