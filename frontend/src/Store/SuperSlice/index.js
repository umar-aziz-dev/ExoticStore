  ...
  async (formData, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        "http://localhost:5000/superadmin/admincreate/add",
        formData
      );
      return res.data;
    } catch (err) {
...
export const FetchAdmin = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const res = await axios.get("http://localhost:5000/superadmin/admincreate/get");
      return res.data;
    } catch (err) {
...
export const DeleteAdmin = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      const res = await axios.post(`http://localhost:5000/superadmin/admincreate/delete/${id}`);
      return res.data;
    } catch (err) {
