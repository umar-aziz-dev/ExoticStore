    ...
    async (id, { rejectWithValue }) => {
        try {
            const result = await axios.get(
                `http://localhost:5000/seller/product/fetch/${id}`
            );
            return result.data;
        } catch (err) {
    ...
    async (id, { rejectWithValue }) => {
        try {
            const result = await axios.delete(
                `http://localhost:5000/seller/product/delete/${id}`
            );
            return result.data;
        } catch (err) {
...
export const UpdateStatus = createAsyncThunk(
    ...
    async ({ id, formdata }, { rejectWithValue }) => {
        try {
            const result = await axios.post(
                `http://localhost:5000/seller/soldproducts/${id}`,
                formdata
            );
            return result.data;
        } catch (err) {
...
export const fetchSoldProducts = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            const result = await axios.get(
                "http://localhost:5000/seller/soldproducts/soldproductview/get"
            );
            return result.data;
        } catch (err) {
...
export const fetchSingleSoldProduct = createAsyncThunk(
    ...
    async (id, { rejectWithValue }) => {
        try {
            const result = await axios.get(
                `http://localhost:5000/seller/soldproducts/soldproductdetails/get/${id}`
            );
            return result.data;
        } catch (err) {
