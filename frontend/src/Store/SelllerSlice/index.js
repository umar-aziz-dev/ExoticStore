...
export const fetchProduct = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            const result = await axios.get("/api/seller/product/get");
            return result.data;
        } catch (err) {
...
export const fetchSoldProducts = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            const result = await axios.get(
                "/api/seller/soldproducts/soldproductview/get"
            );
            return result.data;
        } catch (err) {
...
export const fetchSingleSoldProduct = createAsyncThunk(
    ...
    async (id, { rejectWithValue }) => {
        try {
            const result = await axios.get(
                `/api/seller/soldproducts/soldproductdetails/get/${id}`
            );
            return result.data;
        } catch (err) {
